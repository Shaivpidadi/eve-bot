 ...
 * conversation well and cheaply, and light reasoning is enough to write a
 * brief; `BOT_HQ_MODEL` picks another. With `BOT_MODEL_BASE_URL` set, HQ runs
 * on that endpoint's model instead.
 */
